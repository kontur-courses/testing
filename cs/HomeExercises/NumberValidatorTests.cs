...
namespace HomeExercises
{
    ...
    public class NumberValidatorTests
    {
	    ...
	    [Test]
        [TestCase(3, 2, true, "00.00", ExpectedResult = false, TestName = "Number is longer than precision isn't valid ")]
	    [TestCase(3, 2, true, "-0.3", ExpectedResult = false, TestName = "Negative isn't valid on enabled positive flag")]
	    [TestCase(17, 2, true, "0.000", ExpectedResult = false, TestName = "Fractional part is longer than scale isn't valid")]
	    [TestCase(3, 2, true, "a.sd", ExpectedResult = false, TestName = "Not number isn't valid")]
	    [TestCase(4, 1, true, "", ExpectedResult = false, TestName = "Empty string isn't valid")]
	    [TestCase(4, 1, true, null, ExpectedResult = false, TestName = "Null isn't valid")]
        public bool IsValidNumber_False_WhenArgsIsCorrect(int precision, int scale, bool onlyPositive, string value)
	    {
		    return new NumberValidator(precision, scale, onlyPositive).IsValidNumber(value);
	    }
        ...
        public void Constructor_ThrowException_OnIncorrectArgs(int precision, int scale, bool onlyPositive)
        {
