...
Test string is ""{testString}""");
        ...
        [TestCase(3, 1, false, "-1***.1", TestName = "StringWithOtherSymbols1InIntPart")]
        [TestCase(3, 1, false, "-1.***1", TestName = "StringWithOtherSymbolsInFracPart")]
        [TestCase(3, 1, false, "-***1.1", TestName = "StringWithOtherSymbolsAfterSigh")]
