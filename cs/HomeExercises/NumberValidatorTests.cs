...
namespace HomeExercises
{
	public class NumberValidatorTests
	{
		...
		public void DontThrowException_When(
			int precision, int scale, bool onlyPositive)
		{
			Action validator = () => new NumberValidator(precision, scale, onlyPositive);
		...
		[TestCase("-5,1", 4, 2, false, true, TestName = "Scale is bigger than fractional part")]
		...
		[TestCase("2,3", 4, 2, false, true, TestName = "Number length is smaller then precision")]
