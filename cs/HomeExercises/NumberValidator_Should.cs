...
namespace HomeExercises
{
	public class NumberValidator_Should
	{
		...
		[TestCase(4, 3, "00.00", TestName = "when number is equal to precision")]
		...
		[TestCase(17, 10, "--0.0", true, TestName = "when value have two signs")]
		[TestCase(17, 10, ".0", true, TestName = "when value have not int part")]
		[TestCase(17, 10, "0.", true, TestName = "when value have point but no fraction")]
		[TestCase(17, 10, "0.0.0", true, TestName = "when value have two points")]
