...
namespace HomeExercises
{
	public class ObjectComparison
	{
		...
		public void CheckCurrentTsar()
		{
			...
			var expectedTsar = new Person(name: "Ivan IV The Terrible", age: 54, height: 170, weight: 70,
				parent: new Person(name: "Vasili III of Russia", age: 28, height: 170, weight: 60, parent: null));

			actualTsar.ShouldBeEquivalentTo(expectedTsar, options => options.Excluding(subject => IsId(subject)));
		}
