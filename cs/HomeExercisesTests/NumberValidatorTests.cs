...
namespace HomeExercisesTests
{
	...
	public class NumberValidatorTests
	{
		...
		[TestCase(3, 2, "-1.2", ExpectedResult = false, TestName = "Sign: negative input is not accepted when only positive", Category = "Format")]
		[TestCase(3, 2, "=1.2", false, ExpectedResult = false, TestName = "Sign: only '+' and '-' can be used", Category = "Format")]
		[TestCase(2, 0, "=5", ExpectedResult = false, TestName = "Sign: only '+' and '-' can be used when only positive", Category = "Format")]
		...
		[TestCase(2, 0, "+1", ExpectedResult = true, TestName = "Sign: + is accepted", Category = "Format")]
		...
		[TestCase(3, 1, "-1.7", false, ExpectedResult = true, TestName = "Accept negative numbers if not only positive ones", Category = "Format")]
