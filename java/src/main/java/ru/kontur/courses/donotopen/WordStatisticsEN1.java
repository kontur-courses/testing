...
public class WordStatisticsEN1 implements WordStatistics {
    protected Map<String, Integer> statistics = new HashMap<>();
    ...
    public List<WordCount> getStatistics() {
        ...
        return temp.entrySet().stream().map(it -> new WordCount(it.getKey(), it.getValue())).sorted((left, right) -> {
